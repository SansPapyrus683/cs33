...
0000000000400e20 <_start>:
  ...
  400e3d:	48 c7 c7 e0 10 40 00 	mov    $mov    %eax,-0x28(%rsp)
...
000000000040179d <getbuf>:
  ...
  4017a4:	e8 31 02 00 00       	callq  4019da <Gets>
...
00000000004017b3 <touch1>:
  ...
  4017b7:	c7 05 3b 2d 20 00 01 	movl   $0x1,0x202d3b(%rip)        # 6044fc <vlevel>
  4017be:	00 00 00 
  4017c1:	bf 03 30 40 00       	mov    $0x403003,%edi
  4017c6:	e8 85 f4 ff ff       	callq  400c50 <puts@plt>
  4017cb:	bf 01 00 00 00       	mov    $0x1,%edi
  4017d0:	e8 f4 03 00 00       	callq  401bc9 <validate>
...
0000000000401835 <hexmatch>:
  ...
  401880:	be 20 30 40 00       	mov    $0x403020,%esi
...
00000000004018b3 <touch3>:
  ...
  4018b7:	c7 05 3b 2c 20 00 03 	movl   $0x3,0x202c3b(%rip)        # 6044fc <vlevel>
  4018be:	00 00 00 
  4018c1:	48 89 fe             	mov    %rdi,%rsi
  4018c4:	8b 3d 3a 2c 20 00    	mov    0x202c3a(%rip),%edi        # 604504 <cookie>
...
0000000000401917 <test>:
  ...
  401927:	bf c8 30 40 00       	mov    $0x4030c8,%edi
...
0000000000401940 <save_char>:
  ...
  401958:	0f b6 b1 f0 33 40 00 	movzbl 0x4033f0(%rcx),%esi
  ...
  40196f:	0f b6 b7 f0 33 40 00 	movzbl 0x4033f0(%rdi),%esi
...
00000000004019ab <check_fail>:
  ...
  4019af:	0f be 35 8e 27 20 00 	movsbl 0x20278e(%rip),%esi        # 604144 <target_prefix>
  4019b6:	b9 20 45 60 00       	mov    $0x604520,%ecx
  4019bb:	8b 15 37 2b 20 00    	mov    0x202b37(%rip),%edx        # 6044f8 <check_level>
  4019c1:	bf eb 30 40 00       	mov    $0x4030eb,%edi
...
0000000000401a2c <notify_server>:
  ...
  401a53:	bf 20 32 40 00       	mov    $0x403220,%edi
  ...
  401a6c:	44 0f be 0d d0 26 20 	movsbl 0x2026d0(%rip),%r9d        # 604144 <target_prefix>
  401a73:	00 
  ...
  401a90:	b9 01 31 40 00       	mov    $0x403101,%ecx
  401a95:	eb 05                	jmp    401a9c <notify_server+0x70>
  401a97:	b9 06 31 40 00       	mov    $0x403106,%ecx
  ...
  401aae:	be 0b 31 40 00       	mov    $0x40310b,%esi
  ...
  401aec:	48 8b 35 ad 29 20 00 	mov    0x2029ad(%rip),%rsi        # 6044a0 <course>
  ...
  401b08:	bf 27 31 40 00       	mov    $0x403127,%edi
  ...
  401b4a:	be 01 31 40 00       	mov    $0x403101,%esi
  401b4f:	90                   	nop
  401b50:	eb 05                	jmp    401b57 <notify_server+0x12b>
  401b52:	be 06 31 40 00       	mov    $0x403106,%esi
  401b57:	bf 88 32 40 00       	mov    $0x403288,%edi
  ...
  401b6d:	bf 44 31 40 00       	mov    $0x403144,%edi
  401b72:	b8 00 00 00 00       	mov    $0x0,%eax
  401b77:	e8 04 f1 ff ff       	callq  400c80 <printf@plt>
  401b7c:	48 8b 35 1d 29 20 00 	mov    0x20291d(%rip),%rsi        # 6044a0 <course>
  401b83:	bf 51 31 40 00       	mov    $0x403151,%edi
  ...
  401b99:	bf 5d 31 40 00       	mov    $0x40315d,%edi
  ...
  401baf:	00 
  401bb0:	bf 66 31 40 00       	mov    $0x403166,%edi
...
0000000000401bc9 <validate>:
  ...
  401bdd:	bf 72 31 40 00       	mov    $0x403172,%edi
  ...
  401bfd:	bf b0 32 40 00       	mov    $0x4032b0,%edi
  ...
  401c16:	0f be 35 27 25 20 00 	movsbl 0x202527(%rip),%esi        # 604144 <target_prefix>
  401c1d:	b9 20 45 60 00       	mov    $0x604520,%ecx
  401c22:	89 fa                	mov    %edi,%edx
  401c24:	bf 90 31 40 00       	mov    $0x403190,%edi
  ...
  401c3d:	bf 72 31 40 00       	mov    $0x403172,%edi
  ...
  401c55:	0f be 15 e8 24 20 00 	movsbl 0x2024e8(%rip),%edx        # 604144 <target_prefix>
  401c5c:	89 fe                	mov    %edi,%esi
  401c5e:	bf d8 32 40 00       	mov    $0x4032d8,%edi
...
0000000000401ca3 <bushandler>:
  ...
  401cb0:	bf a5 31 40 00       	mov    $0x4031a5,%edi
  ...
  401cc4:	bf 10 33 40 00       	mov    $0x403310,%edi
  401cc9:	e8 82 ef ff ff       	callq  400c50 <puts@plt>
  401cce:	bf af 31 40 00       	mov    $0x4031af,%edi
...
0000000000401cf1 <seghandler>:
  ...
  401cfe:	bf c5 31 40 00       	mov    $0x4031c5,%edi
  ...
  401d12:	bf 30 33 40 00       	mov    $0x403330,%edi
  401d17:	e8 34 ef ff ff       	callq  400c50 <puts@plt>
  401d1c:	bf af 31 40 00       	mov    $0x4031af,%edi
...
0000000000401d3f <illegalhandler>:
  ...
  401d4c:	bf d8 31 40 00       	mov    $0x4031d8,%edi
  ...
  401d60:	bf 58 33 40 00       	mov    $0x403358,%edi
  401d65:	e8 e6 ee ff ff       	callq  400c50 <puts@plt>
  401d6a:	bf af 31 40 00       	mov    $0x4031af,%edi
...
0000000000401d8d <sigalrmhandler>:
  ...
  401d9a:	bf ec 31 40 00       	mov    $0x4031ec,%edi
  ...
  401db3:	bf 88 33 40 00       	mov    $0x403388,%edi
...
0000000000401ddb <launch>:
  ...
  401e10:	bf f4 31 40 00       	mov    $0x4031f4,%edi
  ...
  401e50:	bf 0c 32 40 00       	mov    $0x40320c,%edi
...
0000000000401e5c <stable_launch>:
  ...
  401ea6:	be c0 33 40 00       	mov    $0x4033c0,%esi
  ...
  401ecd:	48 89 15 54 32 20 00 	mov    %rdx,0x203254(%rip)        # 605128 <stack_top>
...
0000000000401f22 <sigalrm_handler>:
  ...
  401f2b:	be 00 34 40 00       	mov    $0x403400,%esi
...
0000000000401f4b <urlencode>:
  ...
  401fd1:	be 98 34 40 00       	mov    $0x403498,%esi
...
0000000000402187 <submitr>:
  ...
  4024df:	be 28 34 40 00       	mov    $0x403428,%esi
  ...
  402654:	00 
  402655:	be 9f 34 40 00       	mov    $0x40349f,%esi
  ...
  4027ed:	be 68 34 40 00       	mov    $0x403468,%esi
  ...
  40284d:	bf b0 34 40 00       	mov    $0x4034b0,%edi
...
00000000004028ca <init_driver>:
  ...
  402969:	bf 9e 2f 40 00       	mov    $0x402f9e,%edi
...
0000000000402a93 <driver_post>:
  ...
  402aa3:	bf b5 34 40 00       	mov    $0x4034b5,%edi
  ...
  402ae1:	bf 9e 2f 40 00       	mov    $0x402f9e,%edi
